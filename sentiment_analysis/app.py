...
import pandas as pd 
from sentiment_utils import load_model, analyze_sentiment, display_single_result 
 
# Set page configuration 
st.set_page_config( 
    page_title="Sentiment Analysis.ipynb", 
    page_icon="💬", 
    layout="centered" 
) 
...
def main(): 
    ...
    st.markdown("Enter text below to analyze sentiment using a state-of-the-art transformer-based model")
   ...
   # Text input area 
    ...
    if st.button("Analyze Sentiment", type="primary", use_container_width=True): 
        if text_input.strip(): 
            ...
            if results: 
                display_single_result(results,model_name,text_input) 
        else: 
